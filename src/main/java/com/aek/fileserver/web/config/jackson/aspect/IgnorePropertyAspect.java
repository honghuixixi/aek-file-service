package com.aek.fileserver.web.config.jackson.aspect;
...
import com.aek.fileserver.web.config.jackson.annotation.IgnoreProperties;
import com.aek.fileserver.web.config.jackson.impl.FilterPropertyHandler;
import com.aek.fileserver.web.config.jackson.impl.JavassistFilterPropertyHandler;
...
public class IgnorePropertyAspect {
	...
	@Pointcut("@annotation(com.aek.fileserver.web.config.jackson.annotation.IgnoreProperties)")
